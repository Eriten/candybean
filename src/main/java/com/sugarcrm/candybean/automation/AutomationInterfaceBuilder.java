...
public class AutomationInterfaceBuilder {
	 ...
	 *				<td>Android</td>
	 *				<td>
	 *					To build an Android interface, the {@link Type} <b>must</b> be set to {@link Type}. If a type is not specified, the builder will
	 ...
	 *				<td>Apple IOS</td>
	 *				<td>
	 *					To build an IOS interface, the {@link Type} <b>must</b> be set to {@link Type}. If a type is not specified, the builder will
