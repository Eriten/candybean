...
/**
 * This is a list if available wait conditions for WebDriverPause. It is a mix of conditions implemented
 * by Selenium and custom conditions that implements ExpectedCondition<RETURN_TYPE>.
...
public class WaitConditions {
	 ...
	 */
	private static By getBy(Hook hook) throws CandybeanException {
	 ...
	 * @return
	 */
	private static WebElement findElement(Hook hook, WebDriver driver){
		try {
	...
	/**
	 * This returns the negated condition (!condition)
